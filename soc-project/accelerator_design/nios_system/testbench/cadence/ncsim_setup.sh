...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_mm_interconnect_0_rsp_demux_006.sv"                         -work rsp_demux_006                                                          -cdslib ./cds_libs/rsp_demux_006.cds.lib                                                         
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_mm_interconnect_0_cmd_mux_006.sv"                           -work cmd_mux_006                                                            -cdslib ./cds_libs/cmd_mux_006.cds.lib                                                           
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                            -work cmd_mux_006                                                            -cdslib ./cds_libs/cmd_mux_006.cds.lib                                                           
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_mm_interconnect_0_router_009.sv"                            -work router_009                                                             -cdslib ./cds_libs/router_009.cds.lib                                                            
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_mm_interconnect_0_router_004.sv"                            -work router_004                                                             -cdslib ./cds_libs/router_004.cds.lib                                                            
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_switches.v"                                                 -work switches                                                               -cdslib ./cds_libs/switches.cds.lib                                                              
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_rleds.v"                                                    -work rleds                                                                  -cdslib ./cds_libs/rleds.cds.lib                                                                 
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_gleds.v"                                                    -work gleds                                                                  -cdslib ./cds_libs/gleds.cds.lib                                                                 
